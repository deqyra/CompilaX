...
#define PROJECT_NAME "CompilaX"
#define PROJECT_VERSION "1.0"
#define COPYRIGHT_NOTICE "2021 © François Brachais <deqyra@gmail.com>"
#define MIT_LICENSE_NOTICE "This software and its source code are subject to the "\
      "MIT license.\nSee file LICENSE.md at https://github.com/deqyra/CompilaX. "
#define GL_CONTEXT_VERSION_MAJOR 
#define GL_CONTEXT_VERSION_MINOR 
